...
public class MMTouchButton : MonoBehaviour, IPointerDownHandler, IPointerUpHandler, IPointerExitHandler, IPointerEnterHandler, ISubmitHandler
{
	...
	[Header("Opacity")]
	[Tooltip("Here you can set different opacities for the button when it's pressed, idle, or disabled. Useful for visual feedback.")]
	...
	[Header("Delays")]
	[Tooltip("Specify here the delays to apply when the button is pressed initially, and when it gets released. Usually you'll keep them at 0.")]
	...
	[Header("Animation")]
	[Tooltip("Here you can bind an animator, and specify animation parameter names for the various states.")]
	...
	[Header("Mouse Mode")]
	[Tooltip("If you set this to true, you'll need to actually press the button for it to be triggered, otherwise a simple hover will trigger it (better to leave it unchecked if you're going for touch input).")]
